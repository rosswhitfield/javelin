...
def test_mcrun():
    ...
    assert_equal(a[:, 0, 0, 0], [13, 42, 42, 42, 13, 42, 13, 13, 42, 42])
    assert_almost_equal(x[:, 0, 0, 0], [-0.1749765, -0.0331777, -0.053128,   0.02224,   -0.0544439,
                                        -0.1841188, -0.0881798,  0.1831936, -0.0251879, -0.0438136])
    assert_almost_equal(y[:, 0, 0, 0], [-0.1704651,  0.0222391,  0.1586171, -0.149772,  -0.1415043,
                                        0.0301049, -0.0008899, -0.0455922, -0.1396999, -0.1958081])
    assert_almost_equal(z[:, 0, 0, 0], [0.0604424,  0.0369611,  0.0423457, -0.1094557, -0.0164025,
                                        0.0025192,  0.0403598,  0.017637,   0.0391439,  0.1241082])
